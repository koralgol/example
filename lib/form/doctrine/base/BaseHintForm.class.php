...
/**
 * Hint form base class.
 *
 * @method Hint getObject() Returns the current form's model object
 *
 * @package    byexample
 * @subpackage form
 * @author     koralgol
 ...
 */
abstract class BaseHintForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'Hint', 'column' => array('slug')))
    );

    $this->widgetSchema->setNameFormat('hint[%s]');
